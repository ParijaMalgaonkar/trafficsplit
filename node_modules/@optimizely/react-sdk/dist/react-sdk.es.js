import { createContext, forwardRef, createElement, Component, useContext, useCallback, useState, useEffect, useRef, Fragment, Children, isValidElement, cloneElement } from 'react';
import { getLogger } from '@optimizely/js-sdk-logging';
import hoistNonReactStatics from 'hoist-non-react-statics';
import { enums, createInstance as createInstance$1 } from '@optimizely/optimizely-sdk';
export { OptimizelyDecideOption, enums, errorHandler, eventDispatcher, logging, setLogLevel, setLogger } from '@optimizely/optimizely-sdk';
 ...
 */
var OptimizelyContext = createContext({
    optimizely: null,
    isServerSide: false,
    timeout: 0,
});
...
function hoistStaticsAndForwardRefs(Target, Source, displayName) {
    ...
    var forwardRef$1 = function (props, ref) { return createElement(Target, __assign({}, props, { forwardedRef: ref })); };
    forwardRef$1.displayName = displayName + "(" + (Source.displayName || Source.name) + ")";
    return hoistNonReactStatics(forwardRef(forwardRef$1), Source);
}
...
var logger = getLogger('<OptimizelyProvider>');
 ...
 */
var setupAutoUpdateListeners = function (optimizely, type, value, logger, callback) {
    var loggerSuffix = "re-evaluating " + type + "=\"" + value + "\" for user=\"" + optimizely.user.id + "\"";
    var optimizelyNotificationId = optimizely.notificationCenter.addNotificationListener(enums.NOTIFICATION_TYPES.OPTIMIZELY_CONFIG_UPDATE, function () {
        logger.info(enums.NOTIFICATION_TYPES.OPTIMIZELY_CONFIG_UPDATE + ", " + loggerSuffix);
        callback();
    });
    var unregisterConfigUpdateListener = function () {
        return optimizely.notificationCenter.removeNotificationListener(optimizelyNotificationId);
    };
    var unregisterUserListener = optimizely.onUserUpdate(function () {
...
var hooksLogger = getLogger('ReactSDK');
var HookType;
(function (HookType) {
...
var useExperiment = function (experimentKey, options, overrides) {
    ...
    var _a = useContext(OptimizelyContext), optimizely = _a.optimizely, isServerSide = _a.isServerSide, timeout = _a.timeout;
    if (!optimizely) {
    ...
    var getCurrentDecision = useCallback(function () { return ({
    ...
    var _c = useState(currentDecisionInputs), prevDecisionInputs = _c[0], setPrevDecisionInputs = _c[1];
...
var FeatureComponent = function (props) {
    ...
    return createElement(Fragment, null, children(isEnabled, variables, clientReady, didTimeout));
};
...
function withOptimizely(Component$1) {
    var WithOptimizely = /** @class */ (function (_super) {
        ...
        WithOptimizely.prototype.render = function () {
            ...
            return (createElement(OptimizelyContextConsumer, null, function (value) { return (createElement(Component$1, __assign({}, rest, { optimizelyReadyTimeout: value.timeout, optimizely: value.optimizely, isServerSide: value.isServerSide, ref: forwardedRef }))); }));
        };
        return WithOptimizely;
    }(Component));
    var withRefsForwarded = hoistStaticsAndForwardRefs(WithOptimizely, Component$1, 'withOptimizely');
...
var Experiment = function (props) {
    ...
    if (children != null && typeof children === 'function') {
        // Wrap the return value here in a Fragment to please the HOC's expected React.ComponentType
        // See https://github.com/DefinitelyTyped/DefinitelyTyped/issues/18051
        return createElement(Fragment, null, children(variation, clientReady, didTimeout));
    }
    var match = null;
    ...
    return match ? cloneElement(match, { variation: variation }) : null;
};
 ...
 * limitations under the License.
 */
var logger$1 = getLogger('ReactSDK');
var REACT_SDK_CLIENT_ENGINE = 'react-sdk';
var REACT_SDK_CLIENT_VERSION = '2.6.2';
...
var OptimizelyReactSDKClient = /** @class */ (function () {
    ...
    function OptimizelyReactSDKClient(config) {
        ...
        this._client = createInstance$1(configWithClientInfo);
 ...
 * limitations under the License.
 */
var logger$2 = getLogger('ReactSDK');
/**
...
export { OptimizelyContext, OptimizelyContextConsumer, OptimizelyContextProvider, OptimizelyExperiment, OptimizelyFeature, OptimizelyProvider, OptimizelyVariation, createInstance, logOnlyEventDispatcher, useDecision, useExperiment, useFeature, withOptimizely };
