...
var OptimizelyConfig = /** @class */ (function () {
     ...
     */
    OptimizelyConfig.getExperimentsMap = function (configObj) {
        var _this = this;
                ...
                experiments[experiment.key] = {
                    ...
                    variationsMap: (experiment.variations || []).reduce(function (variations, variation) {
                        variations[variation.key] = {
                            id: variation.id,
                            key: variation.key,
                            variablesMap: _this.getMergedVariablesMap(configObj, variation, experiment.id, featureVariablesMap),
                        };
     ...
     */
    OptimizelyConfig.getMergedVariablesMap = function (configObj, variation, experimentId, featureVariablesMap) {
        var featureId = configObj.experimentFeatureMap[experimentId];
        var variablesObject = {};
        if (featureId) {
            var experimentFeatureVariables = featureVariablesMap[featureId.toString()];
            // Temporary variation variables map to get values to merge.
            var tempVariablesIdMap_1 = (variation.variables || []).reduce(function (variablesMap, variable) {
            ...
            variablesObject = (experimentFeatureVariables || []).reduce(function (variablesMap, featureVariable) {
                var variationVariable = tempVariablesIdMap_1[featureVariable.id];
     ...
     */
    OptimizelyConfig.getFeaturesMap = function (configObj, allExperiments) {
...
ProjectConfigManager.prototype.__initialize = function (config) {
    ...
    var handleNewDatafileException;
    if (config.datafile) {
...
ProjectConfigManager.prototype.__handleNewDatafile = function (newDatafile) {
    var _a = projectConfig.tryCreatingProjectConfig({
...
var createProjectConfigManager = function (config) {
 ...
 */
function getExperimentId$1(decisionObj) {
    var _a, _b;
...
var buildImpressionEvent = function (_a) {
    ...
    var experimentId = getExperimentId$1(decisionObj);
